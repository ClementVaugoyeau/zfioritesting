		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Testing ",
									"targetURL": "#zfioritesting-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zfioritesting-display": {
								"semanticObject": "zfioritesting",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zfioritesting",
									"url": sap.ui.require.toUrl("zfioritesting")
								}
							}
						}
					}
